...
def verify(name: str = "owner", threshold: float = 0.70, duration: int = 2) -> bool:
    """
    声纹验证 (带 audio_lock 防录音冲突)
    threshold: 0.70=宽松(实时命令), 0.90=严格(安全操作)
    """
