...
MODEL = f"{YOLO_DIR}/model/yolov5s_qsm368zp.rknn"
...
def _parse_output(output: str, img_w: int = 640, img_h: int = 480) -> list:
...
def detect_vehicles(image_path: str) -> list:
    ...
    try:
        result = subprocess.run(
            [BINARY, MODEL, image_path],
            cwd=YOLO_DIR,
            env={"LD_LIBRARY_PATH": LIB_PATH, **os.environ},
